...
//    CGRect frame1 = CGRectMake(0, 20+44-44, _DEVICE_WIDTH, _DEVICE_HEIGHT+44);
    CGRect frame2 = CGRectMake(_DEVICE_WIDTH/2-179/2, 104, 179, 179);
    //CGRect frame3 = CGRectMake(179/2-50/2, 179/2-93.5/2, 179, 179);
    CGRect frame4 = CGRectMake(_DEVICE_WIDTH/2-35/2, 104+179/2-58.5/2-10, 35, 58.5);
...
//    [self addSubview:backBlackImageView];
    ...
    _talkingImageView = [[UIImageView alloc] initWithFrame:frame2];
